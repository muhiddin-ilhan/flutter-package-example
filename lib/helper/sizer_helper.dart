...
extension SizerExtension on BuildContext {
  ...
  double get mediumValue5 => allHeight * 0.05;
  double get mediumValue6 => allHeight * 0.06;
  double get mediumValue7 => allHeight * 0.07;
  double get highValue4 => allHeight * 0.4;
  double get highValue1 => allHeight * 0.1;
  double get highValue2 => allHeight * 0.2;
  double get highValue2_2 => allHeight * 0.22;
  double get highValue2_5 => allHeight * 0.25;
  double get highValue3 => allHeight * 0.3;  
  double get lowValueWidth => allWidth * 0.01;
  ...
  double get screenWidth055 => allWidth * 0.055;
  ...
  /// Dynamically resize a width.
  ///   double get screenHeight01 => allHeight * 0.01;
  ...
  double get screenHeight85 => allHeight * 0.85;
...
extension TextSizeX on BuildContext {
  ...
  double get fontSizeExtraExtraLarge => 36;
}
...
extension FontWeightX on BuildContext {
  ...
  FontWeight get fontWeightW100 => FontWeight.w100;
  FontWeight get fontWeightW200 => FontWeight.w200;
  FontWeight get fontWeightW300 => FontWeight.w300;
  FontWeight get fontWeightW400 => FontWeight.w400;
  FontWeight get fontWeightW500 => FontWeight.w500;
  FontWeight get fontWeightW600 => FontWeight.w600;
  FontWeight get fontWeightW700 => FontWeight.w700;
  FontWeight get fontWeightW800 => FontWeight.w800;
  FontWeight get fontWeightW900 => FontWeight.w900;
}
...
extension PaddingX on BuildContext {
  ...
  EdgeInsets get paddingMedium5 => EdgeInsets.all(mediumValue5);
  ...
  EdgeInsets get onlyTopPaddingSemiMediumValue => EdgeInsets.only(top: semiMediumValue);
  ...
  EdgeInsets get onlyTopPaddingMedium5 => EdgeInsets.only(top: mediumValue5);
  EdgeInsets get onlyTopPaddingMedium7 => EdgeInsets.only(top: mediumValue7);
  EdgeInsets get onlyTopPaddingHigh1 => EdgeInsets.only(top: highValue1);
...
extension BorderX on BuildContext {
  ...
  BorderRadius get infoBoxBorderRadius => const BorderRadius.all(Radius.circular(13));
  ...
  BorderRadius get radiusSmall => const BorderRadius.all(Radius.circular(4));
  ...
  BorderRadius get borderRadiusMedium => BorderRadius.circular(30);
  ...
  RoundedRectangleBorder get roundedRectanglAllBorderMedium =>
      RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(mediumValue)),
      );
  RoundedRectangleBorder get roundedRectanglAllBorderNormal =>
      RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(normalValue)),
      );
  RoundedRectangleBorder get roundedRectanglAllBorderLow =>
      RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(lowValue)),
      );
...
extension EmptyWidget on BuildContext {
  ...
  Widget get emptySizedWidthBoxLowWidth => SizedBox(width: lowValueWidth);
  ...
  Widget get emptySizedHeightBox4px => const SizedBox(height: 4);

  Widget get emptySizedHeightBox8px => const SizedBox(height: 8);
...
extension TextAlignX on BuildContext {
  TextAlign get tAlignCenter => TextAlign.center;
  TextAlign get tAlignStart => TextAlign.start;
  TextAlign get tAlignEnd => TextAlign.end;
  TextAlign get tAlignJustify => TextAlign.justify;
  TextAlign get tAlignLeft => TextAlign.left;
  TextAlign get tAlignRight => TextAlign.right;
}
