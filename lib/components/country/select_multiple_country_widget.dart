...
class SelectMultipleCountryWidget extends BaseComponent {
  ...
  const SelectMultipleCountryWidget({
    super.key,
  ...
  @override
  State<SelectMultipleCountryWidget> createState() => _SelectMultipleCountryWidgetState();
}

class _SelectMultipleCountryWidgetState extends State<SelectMultipleCountryWidget> {
  ...
  Widget textWidget(bool hasError) {
    return VCProductText(
      text: "Add Countries to Restrict",
      maxLines: 1,
