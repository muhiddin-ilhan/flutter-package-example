...
import 'package:vc_product_widgets/components/sliding_up_panel/sliding_up_panel_controller.dart';
...
class VCSlidingUpPanel extends StatefulWidget {
  ...
  /// If non-null and true, the SlidingUpPanel extends a
  /// indicator on the header. When the indicator is pressed,
  /// the panel opens and closes
  final bool? indicatorEnabled;

  const VCSlidingUpPanel(
      {Key? key,
      this.panel,
      this.panelBuilder,
      this.body,
  ...
  @override
  VCSlidingUpPanelState createState() => VCSlidingUpPanelState();
}

class VCSlidingUpPanelState extends State<VCSlidingUpPanel>
                    ...
                    return Container(
                      ...
                      decoration: widget.renderPanelSheet
                          ? BoxDecoration(
                              ...
                              borderRadius: widget.borderRadius ?? const BorderRadius.only(topLeft:  Radius.circular(8),topRight:  Radius.circular(8)),
  ...
  buildSlidingPanelIndicator() {
    if (widget.indicatorEnabled == false) {
