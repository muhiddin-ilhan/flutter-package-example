...
import 'package:vc_product_widgets/components/sliding_up_panel/sliding_up_panel.dart';

class PanelController {
  VCSlidingUpPanelState? _panelState;

  void addState(VCSlidingUpPanelState panelState) {
  ...
  Future<void> animatePanelToPosition(double value,
    ...
    return _panelState!
        .animatePanelToPosition(value, duration: duration, curve: curve);
  }
  ...
  Future<void> animatePanelToSnapPoint(
    ...
    return _panelState!
        .animatePanelToSnapPoint(duration: duration, curve: curve);
  }
