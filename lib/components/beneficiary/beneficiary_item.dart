...
enum BeneficiaryItemType { type1, type2 }

enum BeneficiaryTitleType { from, to, none }
...
class BeneficiaryItem extends StatefulWidget {
  ...
  final BeneficiaryItemType type;
  final BeneficiaryTitleType titleType;
  ...
  const BeneficiaryItem({
    ...
    this.type = BeneficiaryItemType.type1,
    this.titleType = BeneficiaryTitleType.none,
...
class _BeneficiaryItemState extends State<BeneficiaryItem> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  if (widget.titleType != BeneficiaryTitleType.none)
                    VCProductText(
                      text: widget.titleType == BeneficiaryTitleType.from ? "From: " : "To: ",
              ...
              if (widget.type == BeneficiaryItemType.type2)
                Row(
                  children: [
                    VCProductText(
                      text: widget.balanceTitleText ?? "Available Limit: ",
                      textAlign: TextAlign.start,
                      maxLines: 1,
                      type: widget.balanceTitleTypographyType ?? TypographyType.smallText,
                      textColor: widget.isSelected
  ...
  Container get leadingIcon => Container(
        ...
        padding: widget.titleType != BeneficiaryTitleType.none ? context.paddingLow : context.paddingMini,
        decoration: BoxDecoration(
          color: widget.leadingIconBackgroundColor ??
              (widget.titleType != BeneficiaryTitleType.none ? VCProductColors.instance.lightBlue7 : VCProductColors.instance.bottomSheetBGColor),
          borderRadius: BorderRadius.circular(widget.titleType != BeneficiaryTitleType.none ? getLeadingIconHeight : context.lowValue),
        ),
        child: Opacity(
